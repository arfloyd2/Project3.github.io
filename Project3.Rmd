...
mnLogLoss(initial_test, lev = c("No", "Yes"))
```
...
logdta_train <- initial_train %>% dplyr::select(!c(Education_Level,MentHlth,PhysHlth,BMI))

logdta_test <- initial_train %>% dplyr::select(!c(Education_Level,MentHlth,PhysHlth,BMI))
