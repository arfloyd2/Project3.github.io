...
lowerfit <- glm(Diabetes_binary ~ 1, data = as.data.frame(initial_train), family = binomial)

upperfit <- glm(Diabetes_binary ~ ., data = as.data.frame(initial_train), family = binomial)
